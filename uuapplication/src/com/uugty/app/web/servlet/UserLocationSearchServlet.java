 ...
 */
@WebServlet(urlPatterns = { "/userLocationSearch.do" }, asyncSupported = false)
public class UserLocationSearchServlet extends HttpServlet {
	...
	protected void service(HttpServletRequest request,
		...
		user.setUserSex(sessionUser.getUserSex());
		user.setUserWork(sessionUser.getUserWork());
        
		/** 获取附近的人  */
		List<Object> userlist = userService.searchNeighborUser(user);
