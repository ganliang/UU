...
public class WXPayUtil {
	 ...
	 * @param @return
	 * @return UnifiedorderResData 返回类型
	 * @throws
	 */
	...
	/**
	 * @Title: requestRefreshToken
	 * @Description: 请求Refresh_token
	 * @param @param refresh_token
	 * @param @return
	 * @return RefreshTokenResData 返回类型
	 * @throws
	 */
	 ...
	 * @throws
	 */
	public static PayCallResData requestPayCallResData(String xml) {
		try {
	 ...
	 * @throws
	 */
	public static String requestPayCallReqData(PayCallReqData payCallReqData) {
		try {
